...
class Greedy_06_Solution {
    public int solution(int[][] routes) {
        int answer = 0;
        int prevCamera = -30000;

        Arrays.sort(routes, (car1, car2) -> car1[1] - car2[1]);
...
public class Prog_Greedy_06 {
    public static void main(String[] args) {
        Greedy_06_Solution s = new Greedy_06_Solution();
